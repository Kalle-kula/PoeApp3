...
namespace ConsultAdminSkills.ViewModel
{
    public class EmployeeViewModel : BaseViewModel
    {
        ...
        //public ObservableCollection<EmployeeViewModel> SingleEmployeeCollection { get; set; }
        ...
        public EmployeeViewModel(object param)
        {
            ...
            //SingleEmployeeCollection = new ObservableCollection<EmployeeViewModel>();
        }
        // ---------------------------SKILLS-----------------------------:
        public string NameAndSkill
        {
            get
            {
                string firstName = FirstName;
                int lastWord = firstName.Length - 1;
                if (firstName[lastWord].ToString() == "s")
                {
                    return firstName + " " + "Skills:";
                }
                else
                {
                    return firstName + ":s" + " " + "Skills:";
                }
            }
        }

        public List<string> Hepp { get; set; }
        public ObservableCollection<string> AreaSkills { get; set; }
        ...
        public async Task GetExtendedEmployee()
        {
            ...
            if (employeeDetailModel != null)
            {
                ...
                //-----Skills Fake------
                //List<EmployeeViewModel> SingleEmployeeList = new List<EmployeeViewModel>();

                //List<string> hepp = new List<string>();
                //hepp.Add("Xamarin");
                //hepp.Add("C#");
                //hepp.Add("blabla");
                //if (AreaSkills != null)
